...
mangrove_data <- read_csv( here::here("data/workshop1/mangrove_survey_raw.csv"), skip = 5, 
                           ...
                           # Convert known text alts to true NA
```
...
```{r}
penguin_ratios \<- penguins \|\> mutate(body_mass_kg = body_mass_g / 1000, \# Convert grams to kilograms bill_ratio = bill_length_mm / bill_depth_mm \# Bill ratio ) glimpse(penguin_ratios)
```
...
## Piping Directly to Visualisaton
